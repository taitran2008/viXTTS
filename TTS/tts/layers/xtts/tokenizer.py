...
_ordinal_re = {
    ...
    "vi": re.compile(r"([0-9]+)(st|nd|rd|th)"),
}
...
def test_expand_numbers_multilingual():
    test_cases = [
        ...
        ("tôi là ngô nguyễn tường nghi và tôi ở diên khánh ", "vi"),
        ("tôi là tài , hiện tại tôi đang ở nha trang", "vi"),
    ]
